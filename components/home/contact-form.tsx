    ...
    <section className="border-t border-brand-emerald/10 bg-brand-cream py-16">
      <div className="mx-auto grid w-full max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[1.1fr_1fr]">
        ...
        >
          ...
          <div className="pt-2 border-t border-brand-emerald/10">
            <p className="text-xs text-brand-emerald/60 mb-2">Prefer to chat directly?</p>
            <a
              href="https://wa.me/639764065753?text=Hi%2C%20I%20found%20Island%20Properties%20PH%20and%20I%27m%20interested%20in%20learning%20more."
              target="_blank"
