    ...
    <section className="relative h-screen w-full overflow-hidden">
      ...
      >
        <p className="mb-4 text-xs font-semibold uppercase tracking-[0.35em] text-brand-gold">
          {locale === "ko" ? "보홀, 필리핀" : "Bohol, Philippines"}
        </p>

        <h1 className="font-heading max-w-3xl text-4xl font-bold leading-tight text-white sm:text-6xl lg:text-7xl">
          {locale === "ko" ? "낙원은 휴가만을 위한 것이 아닙니다." : <>Paradise isn&apos;t<br />just for holidays.</>}
        </h1>

        <p className="mt-5 max-w-md text-base text-white/80 sm:text-lg">
          {locale === "ko" ? "$65,000부터 보홀의 부동산을 소유하세요. 거주 요건 없음." : "Own a piece of Bohol from $65,000. No residency required."}
        </p>
        ...
        <div className="mt-8">
          ...
          >
            {locale === "ko" ? "매물 보기" : "Explore Properties"}
          </Link>
        </div>
      </div>
      ...
      >
        ...
        >
          ...
          {locale === "ko" ? "궁금하신가요? 유나가 모든 답을 알고 있습니다" : "Questions? Yuna knows every answer"}
